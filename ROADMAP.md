...
- `ENV-STUDIO-R0`: converts Alpha environment-authoring feedback into a unified Environment Studio architecture, pure editor contracts, validation/digest helpers, and a package smoke. It does not add a visible editor route, scientific engines, simulation changes, scoring changes, or a fifth Product Hub card. See [Environment Studio Architecture](docs/environment_studio_architecture.md) and [ENV-STUDIO-R0 Feedback Response](docs/feedback_r1_environment_studio.md).

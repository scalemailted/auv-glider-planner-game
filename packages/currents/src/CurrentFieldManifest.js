export const CURRENT_FIELD_MANIFEST_VERSION = 'current-field-manifest-flow-pkg-r1';

export const CURRENT_FIELD_REQUIRED_SYNTHETIC_CLAIM_BOUNDARY = Object.freeze({
  synthetic: true,
...
export function createCurrentFieldManifest(options = {}) {
...
export function normalizeCurrentFieldManifest(value = {}) {
...
export function validateCurrentFieldManifest(value = {}) {
...
export function currentFieldManifestSummary(value = {}) {
  const manifest = normalizeCurrentFieldManifest(value);
  return {
...
export function currentFieldManifestDigest(value = {}) {

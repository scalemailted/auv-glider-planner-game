export const CURRENT_TERRAIN_BOUNDARY_CONDITION_VERSION = 'current-terrain-boundary-condition-flow-r2a-3';

export function createWetMaskFromBathymetry(options = {}) {
...
export function isWetAtDepth(field = {}, x = 0, y = 0, depthMeters = 0) {
...
export function enforceCurrentTerrainBoundary(options = {}) {
...
export function projectCoastlineNoNormalVelocity({ u = 0, v = 0, wetMask = [], x = 0, y = 0 } = {}) {
...
export function coastlineNormal(wetMask = [], x = 0, y = 0) {
...
export function terrainBoundaryDigest(boundary = {}) {

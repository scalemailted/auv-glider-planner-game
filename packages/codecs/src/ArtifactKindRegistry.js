...
const entries = [
  ...
  entry('alphaReleaseManifest', 'anchor.alpha-release-manifest', '1.0.0', 'schemas/alpha-release-manifest.schema.json', K.ALPHA_CRITICAL, V.PUBLIC, F.PUBLIC_FAIR, 'anchor.alpha-release-manifest.json', [], 'artifactVersion'),
  entry('alphaDiagnosticBundle', 'anchor.alpha-diagnostic-bundle', '1.0.0', 'schemas/alpha-diagnostic-bundle.schema.json', K.ALPHA_CRITICAL, V.PUBLIC_OBSERVATION_ONLY, F.PUBLIC_FAIR, 'anchor.alpha-diagnostic-bundle.json', [], 'artifactVersion'),

export const BATHYMETRY_SOURCE_METADATA_VERSION = 'bathymetry-source-metadata-three-r1-2b';

export function createBathymetrySourceMetadata(options = {}) {
...
export function normalizeBathymetrySourceMetadata(value = {}) {
...
export function validateBathymetrySourceMetadata(metadata = {}) {
  const errors = [];
...
export function bathymetrySourceMetadataSummary(metadata = {}) {
  return {

...
export function createEnvironmentValidationReport({ errors = [], warnings = [], checks = [] } = {}) {
...
export function normalizeClaimBoundary(value = {}) {
  return {
...
export function normalizeOperationalDomain(value = {}, fallback = {}) {
...
export function domainFromAxes({ eastAxisMeters = [], northAxisMeters = [], depthAxisMeters = [], timeAxisSeconds = [], coordinateFrame = 'localEastNorthDown' } = {}) {
...
export function axisExtent(axis = []) {
...
export function fieldDigestOf(value = {}) {
...
export function axisToIndex(axis = [], value = 0) {

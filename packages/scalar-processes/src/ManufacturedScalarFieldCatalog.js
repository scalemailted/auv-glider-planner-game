import { createScalarField4D } from './ScalarField4D.js';

export const MANUFACTURED_SCALAR_FIELD_CATALOG_VERSION = 'manufactured-scalar-field-catalog-process-pkg-r1';

const DEFAULT_DEPTH_AXIS_METERS = Object.freeze([0, 10, 35, 75, 150]);
const DEFAULT_TIME_AXIS_SECONDS = Object.freeze([0, 300, 600, 900]);

export function manufacturedScalarFieldCatalog() {
  return [
...
export function manufacturedScalarFieldDefinition(id) {
...
export function evaluateManufacturedScalar(definitionOrId, point = {}) {
...
export function createManufacturedScalarField(id = 'linearDepthTime', options = {}) {

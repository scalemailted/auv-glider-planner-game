import { WATER_COLUMN_SCHEMA_VERSION } from './WaterColumnProfileRuntime.js';

export const DEPTH_SCIENCE_SCORE_PROFILE_VERSION = 'depth-science-score-profile-three-r1-2a-2';
...
export const DEPTH_SCIENCE_SCORE_PROFILE_IDS = Object.freeze(Object.keys(PROFILE_DEFINITIONS));

export function normalizeDepthScienceScoreProfileId(value = 'legacySurfaceScienceV1', fallback = 'legacySurfaceScienceV1') {
...
export function depthScienceScoreProfileMetadata(profileInput = 'legacySurfaceScienceV1', options = {}) {
  ...
  return {
    ...
    layerSchemaVersion: options.layerSchemaVersion ?? options.waterColumnSchemaVersion ?? WATER_COLUMN_SCHEMA_VERSION,
...
export function depthScienceScoreProfilesCompatible(a = null, b = null) {
...
export function depthScienceScoreProfileComparison(a = null, b = null) {
  const left = depthScienceScoreProfileMetadata(a ?? 'legacySurfaceScienceV1');
  const right = depthScienceScoreProfileMetadata(b ?? 'legacySurfaceScienceV1');
...
export function depthScienceScoreProfileSummary(profileInput = 'legacySurfaceScienceV1') {

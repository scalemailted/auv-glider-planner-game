export const CONTINUOUS_GLIDER_STATE_VERSION = 'continuous-glider-state-three-r1-2a-3';

export function createContinuousGliderState(options = {}) {
  return normalizeContinuousGliderState(options);
}

export function normalizeContinuousGliderState(state = {}) {
...
export function validateContinuousGliderState(state = {}) {
...
export function continuousGliderStateSummary(state = {}) {
  const normalized = normalizeContinuousGliderState(state);
  return {
    version: CONTINUOUS_GLIDER_STATE_VERSION,
...
export function normalizeDivePhase(value) {

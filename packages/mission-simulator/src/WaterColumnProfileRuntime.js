import { finiteNumber } from './MissionSimulationUtil.js';
...
export const WATER_COLUMN_DEPTH_LAYER_IDS = Object.freeze(['surface', 'shallow', 'thermocline', 'midwater', 'deep', 'bottom', 'integratedWaterColumn']);
export const WATER_COLUMN_DEFAULT_LAYER_IDS = Object.freeze(['surface', 'thermocline', 'deep']);
export const WATER_COLUMN_PROFILE_IDS = Object.freeze(['surfaceOnly', 'shallowDive', 'thermoclineDive', 'deepDive', 'fullProfile', 'sawtoothProfile', 'adaptiveVerticalProfile', 'integratedWaterColumn']);
...
export function layerIndexForDepth(depthMeters = 0, configInput = {}) {
  ...
  for (const layerId of config.depthLayerIds) {
    const layerDepth = finiteNumber(waterColumnLayerMetadata(layerId).nominalDepthMeters, 0);

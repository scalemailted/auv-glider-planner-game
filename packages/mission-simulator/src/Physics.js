import { clamp, normalize } from './RuntimeMath.js';
import { estimateBeachingRiskAtCell } from './ShorelineRisk.js';
import { computeHeadingCurrentComponents, currentEnergyMultiplier } from './CurrentAwareRouteCost.js';
import { normalizeWaterColumnConfig } from './WaterColumnProfileRuntime.js';
import { resolveEffectiveDiveProfile, effectiveDiveProfileSummary } from './WaterColumnProfileRuntime.js';

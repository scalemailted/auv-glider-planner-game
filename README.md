...
- game-first mission planning workspace with a production Three.js bathymetric mission world, visible Planning Tools, standard left-drag pan / right-drag orbit / wheel-zoom controls, HTML/CSS mission-control overlays, top selected-glider planning HUD, bottom mission-time slider, waypoint drawer/table, and non-executable planning markers

...
- Process Lab guided examples have CA taxonomy metadata, QA expectations, phenotype metrics, genotype notes, reference model catalog coverage, rule/update-function metadata, explicit fixture-backed initial layers, Behavior QA status, and export metadata;

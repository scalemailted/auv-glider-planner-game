...
- Refactored the Sample / ROI Field Demo taxonomy into Temporal Pattern, Spatial Pattern, State Model, and Process Model controls with Time-Indexed, State-Evolving, and History-Aware labels. See [sample_fields_demo.md](sample_fields_demo.md).

...
REF-ATLAS-UX-R1 keeps the science and launch path unchanged but clarifies the browser workflow before alpha retest. Stage 1 is the Global Atlas Selector with a metadata-only 60 arc-second world overview and patch coverage overlays. Stage 2 is the Regional Patch Workspace after loading a staged fixture such as `monterey_canyon_15s`. Stage 3 is the Generated Reference Environment after bathymetry, deterministic synthetic fields, environment composition, and launch validation. The owner package at `artifacts/owner-review/ref-atlas-ux-r1/` records default-stage evidence, patch coverage, loaded fixture identity, generated bathymetry, generated fields, composed artifact, launch-validation report, Planning launch, mission execution, Debrief, public benchmark export, export/import round trip, cleanup state, and `qa-summary.json` fields for hidden-truth and raw-path exclusion.

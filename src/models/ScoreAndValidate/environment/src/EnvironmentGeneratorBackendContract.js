 const ENVIRONMENT_GENERATOR_BACKEND_CONTRACT_VERSION = 'environment-generator-backend-contract-flow-r2a-5-1';

 const ENVIRONMENT_GENERATOR_BACKENDS = Object.freeze([
  {
 ...
 function normalizeEnvironmentGeneratorBackend(value = 'cpuBathymetryConditionedSyntheticV3') {
 ...
 function validateEnvironmentGeneratorBackend(value = 'cpuBathymetryConditionedSyntheticV3') {
...
module.exports = {ENVIRONMENT_GENERATOR_BACKEND_CONTRACT_VERSION, ENVIRONMENT_GENERATOR_BACKENDS, normalizeEnvironmentGeneratorBackend, validateEnvironmentGeneratorBackend}
 function normalizeDeploymentState(level, mission, plan = null) {
 ...
 function normalizeLevelDeploymentZones(level) {
  if (!level) return [];
 ...
 function normalizeMissionDeployments(level, mission) {
 ...
 function requiresDeploymentSelection(mission, agentId) {
 ...
 function getDeploymentZoneForAgent(level, mission, agentId) {
 ...
 function getDeploymentZonesForAgent(level, mission, agentId) {
  const deployment = getAgentDeployment(mission, agentId);
  const zones = getDeploymentZones(level);
 ...
 function isValidSelectedStart(level, mission, agentId, cell) {
 ...
 function setSelectedStart(level, mission, plan, agentId, cell) {
 ...
 function applyPlanSelectedStarts(level, mission, plan) {
 ...
 function summarizeDeployment(level, mission) {
  return {
...
module.exports = {normalizeDeploymentState, normalizeLevelDeploymentZones, normalizeMissionDeployments, getDeploymentZones, getAgentDeployment, getSelectedStart, requiresDeploymentSelection, getDeploymentZoneForAgent, getDeploymentZonesForAgent, isValidSelectedStart, setSelectedStart, applyPlanSelectedStarts, summarizeDeployment}
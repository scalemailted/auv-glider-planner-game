 const SIGNED_TERRAIN_SURFACE_MODEL_VERSION = 'signed-terrain-surface-model-world-r1-1';

 function createSignedTerrainSurfaceFromBathymetry(bathymetry = {}, options = {}) {
 ...
 function createSignedTerrainSurface(options = {}) {
 ...
 function createLegacySignedTerrainSurfaceFromGrid({ terrain = [], depth = [], minimumNavigableDepthMeters = 1, seaLevelMeters = 0 } = {}) {
 ...
 function sampleSignedTerrainSurface(surface = {}, x, y) {
 ...
 function sampleSignedTerrainSurfaceAtUv(surface = {}, u, v) {
 ...
 function signedTerrainSurfaceSummary(surface = {}) {
 ...
 function validateSignedTerrainSurface(surface = {}) {
  const errors = [];
  const warnings = [];
...
module.exports = {SIGNED_TERRAIN_SURFACE_MODEL_VERSION, createSignedTerrainSurfaceFromBathymetry, createSignedTerrainSurface, createLegacySignedTerrainSurfaceFromGrid, sampleSignedTerrainSurface, sampleSignedTerrainSurfaceAtUv, signedTerrainSurfaceSummary, validateSignedTerrainSurface}
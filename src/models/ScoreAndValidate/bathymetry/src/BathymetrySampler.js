...
const BATHYMETRY_SAMPLER_VERSION = 'bathymetry-sampler-bathy-pkg-r1';

 function createBathymetrySampler(artifact) {
  const normalized = artifact?.type === 'anchor.bathymetry.artifact' ? artifact : BathymetryArtifact.normalizeBathymetryArtifact(artifact);
  return {
 ...
 function sampleBathymetry(artifactOrSampler, eastMeters, northMeters, options = {}) {
 ...
 function sampleBottomDepth(artifactOrSampler, eastMeters, northMeters, options = {}) {
  return sampleBathymetry(artifactOrSampler, eastMeters, northMeters, options).bottomDepthMeters;
}

 function sampleSignedElevation(artifactOrSampler, eastMeters, northMeters, options = {}) {
  return sampleBathymetry(artifactOrSampler, eastMeters, northMeters, options).signedElevationMeters;
}

 function classifyWetLocation(artifactOrSampler, eastMeters, northMeters, options = {}) {
...
module.exports = {createBathymetrySampler, sampleBathymetry, sampleBottomDepth, sampleSignedElevation, classifyWetLocation}
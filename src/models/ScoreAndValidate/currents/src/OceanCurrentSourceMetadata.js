 const OCEAN_CURRENT_SOURCE_METADATA_VERSION = 'ocean-current-source-metadata-flow-r2a-5-1';

 const OCEAN_CURRENT_SOURCE_TIERS = Object.freeze([
 ...
 const OCEAN_CURRENT_REQUIRED_SYNTHETIC_WARNING = 'Scientifically constrained synthetic current field. Not a calibrated ocean forecast. Not real HYCOM or Marine Copernicus data.';

 function normalizeOceanCurrentSourceMetadata(input = {}, defaults = {}) {
 ...
 function validateOceanCurrentSourceMetadata(metadata = {}) {
 ...
 function currentSourceClaimBoundary(metadata = {}) {
  const normalized = normalizeOceanCurrentSourceMetadata(metadata);
  return {
...
module.exports = {OCEAN_CURRENT_SOURCE_METADATA_VERSION, OCEAN_CURRENT_SOURCE_TIERS, OCEAN_CURRENT_REQUIRED_SYNTHETIC_WARNING, normalizeOceanCurrentSourceMetadata, validateOceanCurrentSourceMetadata, currentSourceClaimBoundary}
 const CURRENT_VERTICAL_PROFILE_CONTRACT_VERSION = 'current-vertical-profile-contract-flow-pkg-r2';

 const CURRENT_VERTICAL_PROFILE_FAMILIES = Object.freeze([
 ...
 function createCurrentVerticalStructureDescriptor(options = {}) {
 ...
 function applyVerticalProfileToVector(options = {}) {
 ...
 function applyVerticalProfileSequence(vector = {}, options = {}) {
 ...
 function materialVectorDeltaForColumn(samples = [], options = {}) {
...
module.exports = {CURRENT_VERTICAL_PROFILE_CONTRACT_VERSION, CURRENT_VERTICAL_PROFILE_FAMILIES, createCurrentVerticalStructureDescriptor, applyVerticalProfileToVector, applyVerticalProfileSequence, materialVectorDeltaForColumn}
...
function cellFromPoint(point, mode = 'floor') {
 ...
 function cellToCenterPosition(cell) {
  return {
 ...
 function isCellNavigable(level, mission = null, x, y) {
 ...
 function getSegmentCells(start, end) {
 ...
 function explainSegmentBlockage(start, end, { level = null, mission = null } = {}) {
 ...
 function buildRouteBlockDiagnostic({
  level = null,
  mission = null,
  agentId = null,
...
function debugRouteBlockDiagnostic(diagnostic) {
 ...
 function isSegmentNavigable(start, end, context = {}) {
  return explainSegmentBlockage(start, end, context).ok;
}

 function evaluateReachability(startCell, goalCell, { level = null, mission = null } = {}) {
 ...
 function buildNavigableReachabilityField({ level = null, mission = null, startCell = null, goalCell = null } = {}) {
  const start = cellFromPoint(startCell, 'floor');
...
module.exports = {positionToCell, cellToCenterPosition, isCellNavigable, isPointNavigable, describeCellNavigability, getSegmentCells, explainSegmentBlockage, buildRouteBlockDiagnostic, isSegmentNavigable, evaluateReachability, buildNavigableReachabilityField}
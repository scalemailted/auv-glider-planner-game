 const ROUTE_DIAGNOSTIC_SCHEMA_VERSION = '1.0';

 const ROUTE_DIAGNOSTIC_CATEGORIES = {
  target_on_land: {
 ...
 function buildRouteValidationDiagnostic(issue = {}, context = {}) {
 ...
 function collectRouteDiagnostics(routeAudit = null) {
 ...
 function splitRouteDiagnostics(diagnostics = []) {
  return {
 ...
 function buildSolverValidationFeedback({ routeAudit = null, plan = null, level = null, mission = null, planner = null } = {}) {
 ...
 function formatDiagnosticForUi(diagnostic = null) {
 ...
 function formatDiagnosticDetails(diagnostic = null) {
...
module.exports = {ROUTE_DIAGNOSTIC_SCHEMA_VERSION, ROUTE_DIAGNOSTIC_CATEGORIES, buildRouteValidationDiagnostic, collectRouteDiagnostics, splitRouteDiagnostics, buildSolverValidationFeedback, formatDiagnosticForUi, formatDiagnosticDetails}
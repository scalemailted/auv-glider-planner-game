 ...
 function normalizeWaypointKind(waypoint = {}) {
 ...
 function waypointKindLabel(value) {
 ...
 function waypointKindEventType(value) {
  const kind = typeof value === 'object' ? normalizeWaypointKind(value) : normalizeWaypointKind({ kind: value });
 ...
 function isSurfaceUpdateWaypoint(waypoint = {}) {
  return normalizeWaypointKind(waypoint) === 'surface';
}

 function isTerminalCarryThroughWaypoint(waypoint = {}) {
  return Boolean(
...
module.exports = {WAYPOINT_KINDS, normalizeWaypointKind, waypointKindLabel, waypointKindEventType, isSurfaceUpdateWaypoint, isTerminalCarryThroughWaypoint}
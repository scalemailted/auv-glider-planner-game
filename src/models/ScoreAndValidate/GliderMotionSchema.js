 const GLIDER_MOTION_SCHEMA_VERSION = 'glider-motion-schema-motion-r1';

 const GLIDER_MOTION_MODEL_IDS = Object.freeze([
 ...
 const GLIDER_CONTROL_MODE_IDS = Object.freeze([
  'waypointTracking',
  'headingHold',
  'currentAwareHeading',
  'diveProfileTracking',
 ...
 const GLIDER_MOTION_STATE_FIELDS = Object.freeze([
  'gliderId',
  'timeSeconds',
  'x',
  'y',
 ...
 const GLIDER_CONTROL_FIELDS = Object.freeze([
  'commandId',
  'gliderId',
  'timeSeconds',
  'controlMode',
 ...
 const GLIDER_MOTION_DIAGNOSTIC_IDS = Object.freeze([
  'currentAssistMean',
...
const MOTION_NOT_A = Object.freeze([
 ...
 function normalizeGliderMotionModelId(id) {
 ...
 function normalizeGliderControlModeId(id) {
  const value = String(id ?? '').trim();
  const aliases = {
 ...
 function createGliderMotionConfig(options = {}) {
 ...
 function createGliderMotionState(options = {}) {
 ...
 function createGliderControlCommand(options = {}) {
  return {
 ...
 function validateGliderMotionConfig(config = {}) {
  const errors = [];
  const warnings = [];
 ...
 function validateGliderMotionState(state = {}) {
  const errors = [];
 ...
 function validateGliderControlCommand(command = {}) {
  const errors = [];
 ...
 function gliderMotionConfigSummary(configInput = {}) {
...
module.exports = {GLIDER_MOTION_SCHEMA_VERSION, GLIDER_MOTION_MODEL_IDS, GLIDER_CONTROL_MODE_IDS, GLIDER_MOTION_STATE_FIELDS, GLIDER_CONTROL_FIELDS, GLIDER_MOTION_DIAGNOSTIC_IDS, normalizeGliderMotionModelId, normalizeGliderControlModeId, createGliderMotionConfig, createGliderMotionState, createGliderControlCommand, validateGliderMotionConfig, validateGliderMotionState, validateGliderControlCommand, gliderMotionConfigSummary}
 const VOLUMETRIC_FIELD_SAMPLER_VERSION = 'volumetric-field-sampler-three-r1-2a-3';

 const FIELD_INTERPOLATION_PROFILES = Object.freeze([
  'legacyNearestCellV1',
 ...
 function sampleScalarFieldContinuous(options = {}) {
 ...
 function sampleVectorFieldContinuous(options = {}) {
 ...
 function sampleMaskFieldContinuous(options = {}) {
 ...
 function sampleBathymetryContinuous(options = {}) {
 ...
 function sampleVolumetricFieldContinuous(options = {}) {
  const field = options.field ?? {};
 ...
 function validateVolumetricFieldSample(result = {}) {
  const errors = [];
 ...
 function volumetricFieldSampleSummary(result = {}) {
  return {
    version: VOLUMETRIC_FIELD_SAMPLER_VERSION,
...
module.exports = {VOLUMETRIC_FIELD_SAMPLER_VERSION, FIELD_INTERPOLATION_PROFILES, sampleScalarFieldContinuous, sampleVectorFieldContinuous, sampleMaskFieldContinuous, sampleBathymetryContinuous, sampleVolumetricFieldContinuous, validateVolumetricFieldSample, volumetricFieldSampleSummary}
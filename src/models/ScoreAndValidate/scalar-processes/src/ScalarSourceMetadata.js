 const SCALAR_SOURCE_METADATA_VERSION = 'scalar-source-metadata-process-pkg-r1';

 const SCALAR_SOURCE_TIERS = Object.freeze([
 ...
 const SCALAR_REQUIRED_SYNTHETIC_WARNING = 'Synthetic scalar-process field for ANCHOR education/regression use; not a calibrated ocean forecast, ecological forecast, or operational product.';

 function normalizeScalarSourceMetadata(input = {}, context = {}) {
  ...
  const metadata = {
    ...
    ...(input.referenceFixtureId != null || context.referenceFixtureId != null ? { referenceFixtureId: input.referenceFixtureId ?? context.referenceFixtureId } : {}),
    ...(input.referenceBathymetryPatch != null || context.referenceBathymetryPatch != null ? { referenceBathymetryPatch: input.referenceBathymetryPatch === true || context.referenceBathymetryPatch === true } : {}),
    ...(input.bathymetryConditionedSynthetic != null || context.bathymetryConditionedSynthetic != null ? { bathymetryConditionedSynthetic: input.bathymetryConditionedSynthetic === true || context.bathymetryConditionedSynthetic === true } : {}),
    ...(input.sourceDataset != null || context.sourceDataset != null ? { sourceDataset: input.sourceDataset ?? context.sourceDataset } : {}),
    ...(input.fieldPolicy != null || context.fieldPolicy != null ? { fieldPolicy: input.fieldPolicy ?? context.fieldPolicy } : {}),
    ...(input.sourcePhase != null || context.sourcePhase != null ? { sourcePhase: input.sourcePhase ?? context.sourcePhase } : {}),
 ...
 function validateScalarSourceMetadata(input = {}) {
 ...
 function scalarSourceClaimBoundary(metadata = {}) {
...
module.exports = {SCALAR_SOURCE_METADATA_VERSION, SCALAR_SOURCE_TIERS, SCALAR_REQUIRED_SYNTHETIC_WARNING, normalizeScalarSourceMetadata, validateScalarSourceMetadata, scalarSourceClaimBoundary}
...
const scalarFieldRuntimeCounters = { buildCount: 0, normalizeCount: 0, normalizeHitCount: 0, digestCount: 0, summaryBuildCount: 0 };
 ...
 function getScalarField4DRuntimeCounters() {
  return { ...scalarFieldRuntimeCounters };
}

 function createScalarField4D(options = {}) {
  ...
  const sourceMetadata = ScalarSourceMetadata.normalizeScalarSourceMetadata(options.sourceMetadata ?? options.metadata ?? options.provenance ?? {}, { seed });
  const field = {
  ...
  field.diagnostics = options.diagnostics ?? ScalarFieldDiagnostics.computeScalarFieldDiagnostics(field);
  field.digest = scalarField4DDigest(field);
  markNormalizedField(field);
  return field;
}

 function normalizeScalarField4D(field = {}) {
 ...
 function validateScalarField4D(field = {}) {
  const rawErrors = [];
  ...
  const metadataValidation = ScalarSourceMetadata.validateScalarSourceMetadata(normalized.sourceMetadata ?? {});
  errors.push(...metadataValidation.errors);
  warnings.push(...metadataValidation.warnings);
  const diagnosticsValidation = ScalarFieldDiagnostics.validateScalarFieldDiagnostics(normalized.diagnostics ?? ScalarFieldDiagnostics.computeScalarFieldDiagnostics(normalized));
 ...
 function scalarField4DSummary(field = {}) {
  const normalized = normalizeScalarField4D(field);
  ...
  const diagnostics = normalized.diagnostics ?? ScalarFieldDiagnostics.computeScalarFieldDiagnostics(normalized);
 ...
 function scalarField4DDigest(field = {}) {
  scalarFieldRuntimeCounters.digestCount += 1;
  return ScalarFieldDiagnostics.scalarFieldDigest({
 ...
 function createScalarField4DSampler(field = {}, options = {}) {
  const normalized = normalizeScalarField4D(field);
  return {
 ...
 function sampleScalarField4D(field = {}, sampleOptions = {}) {
  const normalized = normalizeScalarField4D(field);
  return VolumetricFieldSampler.sampleScalarFieldContinuous({
 ...
 function dimensionsForScalarField(field = {}) {
...
module.exports = {resetScalarField4DRuntimeCounters, getScalarField4DRuntimeCounters, createScalarField4D, normalizeScalarField4D, validateScalarField4D, scalarField4DSummary, scalarField4DDigest, createScalarField4DSampler, sampleScalarField4D, dimensionsForScalarField}
 function normalizeForecastRules(missionOrRules = null) {
 ...
 function getForecastConfidenceAtTime(t = 0, forecastRules = null, { updateTime = 0 } = {}) {
 ...
 function applyForecastDecayToFrames(frames = [], forecastRules = null) {
  const rules = normalizeForecastRules(forecastRules);
...
module.exports = {normalizeForecastRules, getForecastConfidenceAtTime, applyForecastDecayToFrames}
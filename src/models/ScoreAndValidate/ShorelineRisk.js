...
const BEACHING_RISK_NONE = {
 ...
 function estimateSegmentBeachingRisk({ level = null, frame = null, start = null, end = null } = {}) {
 ...
 function isBeachingRisk(risk) {
  return Number(risk?.value ?? 0) >= 0.5;
}

 function estimateStochasticCurrentRiskAtCell({
  level = null,
  frame = null,
  x,
  y,
 ...
 function estimateStochasticSegmentCurrentRisk({
  level = null,
  frame = null,
  start = null,
  end = null,
...
function sampleCurrent(frame, level, x, y) {
  return CurrentFieldSampler.sampleCurrentField({ frame, level, x, y });
}
...
module.exports = {estimateBeachingRiskAtCell, estimateSegmentBeachingRisk, isBeachingRisk, estimateStochasticCurrentRiskAtCell, estimateStochasticSegmentCurrentRisk}
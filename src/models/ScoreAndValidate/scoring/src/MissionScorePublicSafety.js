 const MISSION_SCORE_PUBLIC_SAFETY_VERSION = 'mission-score-public-safety-score-r1';
...
const BANNED_PATTERNS = [/"T_hiddenTruth"\s*:/, /"trueRoi"\s*:/, /"eventIntensity"\s*:/, /"hiddenFields"\s*:/, /raw hidden truth/i];
 ...
 function sanitizeMissionOutcomeReportForPublicExport(report = {}, options = {}) {
 ...
 function sanitizeMissionRegretReportForPublicExport(report = {}, options = {}) {
 ...
 function auditMissionScorePublicSafety(record = {}) {
  const warnings = [];
  const failures = [];
 ...
 function missionScorePublicSafetySummary(record = {}) {
...
function compactHiddenEventSummary(value = {}) {
  return {
    ...
    publicSafe: true,
    note: 'Public-safe hidden-event hypothesis summary; raw hidden truth is not ed.'
  };
}
...
module.exports = {MISSION_SCORE_PUBLIC_SAFETY_VERSION, sanitizeMissionOutcomeReportForPublicExport, sanitizeMissionRegretReportForPublicExport, auditMissionScorePublicSafety, missionScorePublicSafetySummary}
 function buildHeadlessPlanningWorld(context) {
 ...
 function solveGreedyHeadlessPlan(world, { maxWaypoints = 4 } = {}) {
...
module.exports = {buildHeadlessPlanningWorld, solveGreedyHeadlessPlan}
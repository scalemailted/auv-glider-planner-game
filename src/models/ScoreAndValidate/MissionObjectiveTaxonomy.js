 const MISSION_OBJECTIVE_TAXONOMY_VERSION = 'mission-objective-taxonomy-p0';

 const MISSION_OBJECTIVE_OPTIONS = [
 ...
 const MISSION_OBJECTIVE_IDS = MISSION_OBJECTIVE_OPTIONS.map((objective) => objective.id);

 function normalizeMissionObjectiveId(id) {
 ...
 function missionObjectiveById(id) {
 ...
 function missionObjectiveOptions() {
 ...
 function objectiveRecommendedFields(id) {
  return [...missionObjectiveById(id).usesFields];
}

 function objectiveSuggestedMetrics(id) {
...
module.exports = {MISSION_OBJECTIVE_TAXONOMY_VERSION, MISSION_OBJECTIVE_OPTIONS, MISSION_OBJECTIVE_IDS, normalizeMissionObjectiveId, missionObjectiveById, missionObjectiveOptions, objectiveRecommendedFields, objectiveSuggestedMetrics}
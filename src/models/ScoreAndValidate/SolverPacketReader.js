 function readHeadlessSolverPacket(packet, { oracle = false } = {}) {
 ...
 function summarizeHeadlessPacket(context) {
...
module.exports = {readHeadlessSolverPacket, summarizeHeadlessPacket}
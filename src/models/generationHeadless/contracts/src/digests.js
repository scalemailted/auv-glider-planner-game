 const STABLE_DIGEST_VERSION = 'stable-json-fnv1a32-arch-r1';
...
function normalizeForStableJson(value) {
 ...
 function digestRecord(kind, value) {
  return {
...
module.exports = {STABLE_DIGEST_VERSION, stableStringify, fnv1a32, stableDigest, artifactDigest, digestRecord}
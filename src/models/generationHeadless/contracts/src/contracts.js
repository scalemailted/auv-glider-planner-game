const digests = require('./digests.js');
 ...
 { digests.artifactDigest, digests.digestRecord };

module.exports = {ANCHOR_CONTRACTS_VERSION, COORDINATE_FRAMES, PHYSICAL_UNITS, TYPED_ARRAY_LAYOUTS, createValidationReport, createProvenanceMetadata, normalizeAxisDefinition, normalizeBathymetryManifest, validateBathymetryManifest, normalizeBathymetryArtifact, validateBathymetryArtifact, normalizeCurrentFieldManifest, normalizeCurrentField4D, normalizeScalarProcessManifest, normalizeScalarField4D, normalizeSyntheticEnvironmentManifestContract, normalizeGeneratedEnvironmentArtifactContract, ...digests}
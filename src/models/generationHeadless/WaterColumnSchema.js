 ...
 const WATER_COLUMN_DEPTH_LAYER_IDS = Object.freeze([
  'surface',
  'shallow',
  'thermocline',
  'midwater',
 ...
 const WATER_COLUMN_PROFILE_IDS = Object.freeze([
  'surfaceOnly',
  'shallowDive',
  'thermoclineDive',
  'deepDive',
 ...
 const WATER_COLUMN_OBSERVATION_TYPES = Object.freeze([
  'depthLayerSample',
  'profileSample',
  'integratedWaterColumnSample'
]);

 const WATER_COLUMN_SUMMARY_IDS = Object.freeze([
...
const REQUIRED_NOT_A = Object.freeze([
 ...
 function validateWaterColumnConfig(config = {}) {
 ...
 function waterColumnConfigSummary(configInput = {}) {
...
module.exports = {WATER_COLUMN_SCHEMA_VERSION, WATER_COLUMN_DEPTH_LAYER_IDS, WATER_COLUMN_DEFAULT_LAYER_IDS, WATER_COLUMN_PROFILE_IDS, WATER_COLUMN_OBSERVATION_TYPES, WATER_COLUMN_SUMMARY_IDS, normalizeWaterColumnLayerId, normalizeWaterColumnLayerIds, normalizeWaterColumnProfileId, waterColumnLayerMetadata, waterColumnLayerOptions, waterColumnProfileOptions, waterColumnNotA, createDefaultWaterColumnConfig, normalizeWaterColumnConfig, validateWaterColumnConfig, waterColumnConfigSummary}
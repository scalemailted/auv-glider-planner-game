 const OPERATIONAL_DOMAIN_SPEC_VERSION = 'operational-domain-spec-world-r1';

 const SYNTHETIC_REGIONAL_DOMAIN_PRESET = Object.freeze({
 ...
 function createOperationalDomainSpec(options = {}) {
 ...
 function createLegacyOperationalDomainFromGrid(grid = {}, options = {}) {
 ...
 function normalizeOperationalDomainSpec(input = {}, options = {}) {
 ...
 function validateOperationalDomainSpec(domain = {}) {
 ...
 function operationalDomainSummary(domain = {}) {
  const normalized = normalizeOperationalDomainSpec(domain);
  return {
 ...
 function operationalDomainDigest(domain = {}) {
  return `fnv1a-${fnv1aHex(stableStringify(normalizeOperationalDomainSpec(domain)))}`;
}

 function isSyntheticEducationalDomain(domain = {}) {
  const normalized = normalizeOperationalDomainSpec(domain);
...
module.exports = {OPERATIONAL_DOMAIN_SPEC_VERSION, SYNTHETIC_REGIONAL_DOMAIN_PRESET, createOperationalDomainSpec, createLegacyOperationalDomainFromGrid, normalizeOperationalDomainSpec, validateOperationalDomainSpec, operationalDomainSummary, operationalDomainDigest, isSyntheticEducationalDomain}
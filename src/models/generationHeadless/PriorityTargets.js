 ...
 function normalizePriorityTargets(level) {
 ...
 function getActivePriorityTargets(level, t) {
 ...
 function getPriorityTargetPosition(target, t) {
 ...
 function isPriorityTargetActive(target, t) {
  return Boolean(getPriorityTargetPosition(target, t)?.active);
}

 function checkPriorityTargetCapture(agent, level, missionState, t) {
 ...
 function summarizePriorityTargets(level, missionState = {}) {
...
module.exports = {DEFAULT_PRIORITY_TARGET_RULES, normalizePriorityTargetRules, normalizePriorityTargets, getActivePriorityTargets, getPriorityTargetPosition, isPriorityTargetActive, checkPriorityTargetCapture, summarizePriorityTargets}
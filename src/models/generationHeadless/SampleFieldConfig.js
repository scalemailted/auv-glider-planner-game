 const SAMPLE_FIELD_MODES = ['static', 'dynamic'];
 const SAMPLE_OBJECTIVE_MODELS = ['coverage', 'hotspot', 'tracking', 'uncertainty', 'mixed'];
 const SAMPLE_SPATIAL_PATTERNS = [
  'uniform',
  'gradient',
  'singleHotspot',
  'multiHotspot',
 ...
 const SAMPLE_TEMPORAL_BEHAVIORS = [
  'static',
  'periodic',
  'bursty',
  'moving',
 ...
 const SAMPLE_STATE_MODELS = ['timeIndexed', 'stateEvolving', 'historyAware'];
 const SAMPLE_DISTRIBUTIONS = ['uniform', 'gaussian', 'bimodal', 'multimodal', 'heavyTail', 'clustered'];

 function createDefaultSampleFieldConfig(mode = 'perfectKnowledge') {
 ...
 function normalizeSampleFieldConfig(config = {}, { mode = 'perfectKnowledge', roiHotspots = 4 } = {}) {
 ...
 function normalizeStateModel(value, temporalBehavior = 'moving') {
  const aliases = {
 ...
 function sampleFieldConfigFromLegacyRoi(config = {}) {
 ...
 function sampleTemporalBehaviorLabel(value) {
  return {
    static: 'Static',
    periodic: 'Periodic',
    bursty: 'Bursty Bloom',
 ...
 function sampleSpatialPatternLabel(value) {
  return {
    uniform: 'Uniform',
    gradient: 'Gradient',
...
module.exports = {SAMPLE_FIELD_MODES, SAMPLE_OBJECTIVE_MODELS, SAMPLE_SPATIAL_PATTERNS, SAMPLE_TEMPORAL_BEHAVIORS, SAMPLE_STATE_MODELS, SAMPLE_DISTRIBUTIONS, createDefaultSampleFieldConfig, normalizeSampleFieldConfig, normalizeStateModel, sampleFieldConfigFromLegacyRoi, sampleTemporalBehaviorLabel, sampleSpatialPatternLabel}
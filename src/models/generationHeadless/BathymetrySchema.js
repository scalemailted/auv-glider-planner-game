 const BATHYMETRY_SCHEMA_VERSION = 'bathymetry-schema-env-r1';

 const BATHYMETRY_FEATURE_IDS = Object.freeze([
  'continentalShelf',
  'shelfBreak',
  'submarineCanyon',
  'trench',
 ...
 const BATHYMETRY_LAYER_IDS = Object.freeze([
  'landSeaMask',
  'bathymetricBottom',
  'waterSurface',
  'surface',
 ...
 const BATHYMETRY_VIEW_MODE_IDS = Object.freeze([
  'topDown',
  'obliqueBathymetry',
  'layerStack',
  'surfaceAndBottom',
 ...
 const BATHYMETRY_SURFACE_IDS = Object.freeze([
  'waterSurface',
  'bathymetricBottom',
  'depthLayerPlane'
]);
...
const REQUIRED_NOT_A = Object.freeze([
 ...
 function createBathymetryLayerDescriptor(options = {}) {
 ...
 function validateBathymetryConfig(config = {}) {
 ...
 function bathymetryConfigSummary(configInput = {}) {
...
module.exports = {BATHYMETRY_SCHEMA_VERSION, BATHYMETRY_FEATURE_IDS, BATHYMETRY_LAYER_IDS, BATHYMETRY_VIEW_MODE_IDS, BATHYMETRY_SURFACE_IDS, normalizeBathymetryFeatureId, normalizeBathymetryViewMode, createBathymetryConfig, createBathymetryLayerDescriptor, validateBathymetryConfig, bathymetryConfigSummary}
...
function clonePlain(value) {
 ...
 function stableDigest(value, prefix = 'fnv1a32') {
  return index.digests.StableDigest(stable(value), prefix);
}
...
module.exports = {stable, stableDigest, compactObject, stringOrNull, finiteNumber, finiteOrNull, positiveNumber, clamp01, round, normalizeArray, validationReport, distance2d, pathDistance}
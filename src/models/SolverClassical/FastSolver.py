...
class Solver():
    def __init__(self, world, scanStrict, scanMax):
        ...
        self.stars = []
        self.hazardPenalty = world["packet"]["mission"]["scoring"]["hazardPenalty"]
        self.finalPaths = []
        # self.numAgents = 2   //h..      
...
file = my_io.load_solver_packet(r"C:\Users\wabbi\Downloads\anchor.solver-packet (40).json")
...
def packet_to_plan(packet, scanStrict, scanMax):
    ...
    print(solverWorld["mission"]["scoring"]["weights"]["hazardPenalty"])
    solved = Solver(solverWorld, scanStrict, scanMax)
    return solved.find_best_paths()

packet_to_plan(packet, 0.01, 1000)
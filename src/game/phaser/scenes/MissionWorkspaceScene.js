...
export class MissionWorkspaceScene extends PhaserScene {
  ...
  updateMissionRenderDebug({ activeBackend, threeMounted, viewModel, renderer = null, parityWarnings = [] } = {}) {
    ...
    globalThis.ANCHOR_MISSION_RENDER_DEBUG = {
      ...
      bathymetryPackageVersion: summary.bathymetryPackageVersion ?? null,
      bathymetryManifestDigest: summary.bathymetryManifestDigest ?? null,
      bathymetryArtifactDigest: summary.bathymetryArtifactDigest ?? null,
      bathymetrySourceType: this.app.state.level?.bathymetryArtifact?.sourceMetadata?.sourceType ?? null,
      bathymetryCoordinateFrame: summary.bathymetryCoordinateFrame ?? null,
      bathymetryAxisCounts: summary.bathymetryAxisCounts ?? null,
      bathymetryWetCellCount: summary.bathymetryWetCellCount ?? null,
      bathymetryLandCellCount: summary.bathymetryLandCellCount ?? null,
      bathymetryValidationStatus: summary.bathymetryValidationStatus ?? null,

...
export function threeMissionWorldRendererSummary(renderer = {}) {
  ...
  return {
    ...
    currentLayerUpdateCount: currentGlyphSummary.currentLayerUpdateCount ?? 0,
    currentLayerSkippedUpdateCount: currentGlyphSummary.currentLayerSkippedUpdateCount ?? 0,
    currentLayerSkipReason: currentGlyphSummary.currentLayerSkipReason ?? null,
    ...
    currentDirectionBufferUploadCount: currentGlyphSummary.currentDirectionBufferUploadCount ?? 0,
    currentMagnitudeBufferUploadCount: currentGlyphSummary.currentMagnitudeBufferUploadCount ?? 0,
    currentVisibilityBufferUploadCount: currentGlyphSummary.currentVisibilityBufferUploadCount ?? 0,
    currentMatrixBufferUploadCount: currentGlyphSummary.currentMatrixBufferUploadCount ?? 0,

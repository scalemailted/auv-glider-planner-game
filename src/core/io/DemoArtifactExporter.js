...
export function buildDemoArtifactEnvelope({
  ...
  foundationalModelId = null,
  oceanProcessAnalogId = null,
  exampleProcessModified = null,
  observableProcessPatternId = null,
  processPatternId = null,
  spatiotemporalProcessExample = null,
  implementationFidelity = null,
  ruleFamilyId = null,
  relatedFoundationalModels = null,
  relatedOceanAnalogs = null,
  relatedObservablePatterns = null,
  observableProcessPatternTags = null,
  requiresFlowCoupling = null,
  requiresUncertaintyForMissionRealism = null,
  environmentalProcess = null,
  underlyingCaMechanism = null,
  samplingInterpretation = null,
  recommendedSamplingStrategy = null,
  missingScienceLayers = null,
  notA = null,
  coupledDemoBridgeNote = null,
  ruleStatement = null,
  localUpdateFunction = null,
  globalUpdateFunction = null,
  caTaxonomy = null,
  ...
  return sanitizeJson({
    ...
    exampleProcessLabel,
    exampleType,
    foundationalCaModelId,
    foundationalModelId,
    oceanProcessAnalogId,
    exampleProcessModified,
    observableProcessPatternId,
    processPatternId,
    spatiotemporalProcessExample,
    ...
    requiresFlowCoupling,
    requiresUncertaintyForMissionRealism,
    environmentalProcess,
    underlyingCaMechanism,
    samplingInterpretation,
    recommendedSamplingStrategy,
    missingScienceLayers,
    notA,
    coupledDemoBridgeNote,
    ruleStatement,
    localUpdateFunction,

...
export const MANUFACTURED_CURRENT_FIELD_CATALOG_VERSION = 'manufactured-current-field-catalog-flow-r2a-3';
...
export function manufacturedCurrentFieldCatalog() {
...
export function createManufacturedCurrentField(id = 'uniformTranslation', options = {}) {
...
export function evaluateExpectedCurrent(idOrField = 'uniformTranslation', x = 0, y = 0, z = 0, t = 0, options = {}) {
...
export function manufacturedCurrentFieldDefinition(id = 'uniformTranslation') {
  const definition = definitionFor(id);

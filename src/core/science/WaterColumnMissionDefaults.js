...
export function buildDefaultWaterColumnMissionConfig(options = {}) {
  ...
  const config = normalizeWaterColumnConfig({
    enabled: true,
...
export function buildLegacySurfaceOnlyWaterColumnConfig(options = {}) {
  const config = normalizeWaterColumnConfig({
    enabled: true,
  ...
  return {
    ...
    layerDefinitions: {
      surface: {
        ...waterColumnLayerMetadata('surface'),
...
export function ensureModernWaterColumnMissionConfig(level, mission, options = {}) {
...
export function ensureLegacySurfaceOnlyWaterColumnConfig(level, mission, options = {}) {
  if (hasWaterColumnConfig(level, mission)) return existingWaterColumnConfig(level, mission);
...
export function validateWaterColumnMissionConfig(config = {}) {
  ...
  return {
    ...
    errors,
    warnings,
    config: normalizeWaterColumnConfig(config)
  };
}

export function waterColumnMissionConfigSummary(config = {}) {
...
export function isLegacySurfaceOnlyMission(config = null) {
...
export function hasWaterColumnConfig(level = null, mission = null) {
  return Boolean(existingWaterColumnConfig(level, mission));
}

export function existingWaterColumnConfig(level = null, mission = null) {
...
export function attachWaterColumnConfig(level = null, mission = null, config = null) {

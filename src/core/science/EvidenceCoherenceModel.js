...
export const EVIDENCE_COHERENCE_MODEL_VERSION = 'evidence-coherence-model-p9';

export function computeEvidenceCoherence(observations = [], options = {}) {
  const thresholds = {
  ...
  const summary = observationSurpriseSummary(surpriseRows, options.surpriseOptions ?? options);
...
export function evidenceCoherenceSummary(coherence = {}) {
  return {

import { computeCurrentMagnitudeStats } from './FluidFieldStats.js';

export function fieldToCurrentMatrix(field, config = {}) {
...
export function currentMagnitudeStats(current) {
  const stats = computeCurrentMagnitudeStats(current);
  return {
    min: stats.minSpeed,
    max: stats.maxSpeed,

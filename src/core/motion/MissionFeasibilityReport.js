export const MISSION_FEASIBILITY_REPORT_VERSION = 'mission-feasibility-report-motion-r1';
...
export function buildMissionFeasibilityReport({
  motionTrajectory,
  plan,
  motionConfig,
  environmentSummary,
...
export function validateMissionFeasibilityReport(report = {}) {
  const errors = [];
  const warnings = [];
...
export function missionFeasibilityReportSummary(report = {}) {
  return {

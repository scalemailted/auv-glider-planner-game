...
export const HEADLESS_EPISODE_SCHEMA_VERSION = 'headless-episode-schema-h0';

export function createHeadlessEpisode(options = {}) {
  ...
  return compactObject({
    ...
    informationAccessTier: normalizeHeadlessVisibilityTier(episode.informationAccessTier ?? 'publicScenario'),
    ...
    exports: cloneJson(normalizeArray(episode.exports)),
    notes: normalizeStringList(episode.notes)
  });
}

export function createHeadlessStepRecord(options = {}) {
  return compactObject({
...
export function createHeadlessObservationRecord(options = {}) {
  return compactObject({
...
export function createHeadlessActionRecord(options = {}) {
  return compactObject({
...
export function createHeadlessRewardRecord(options = {}) {
  return compactObject({
...
export function createHeadlessInfoRecord(options = {}) {
  return compactObject({
...
export function validateHeadlessEpisode(episode = {}) {
  const errors = [];
  const warnings = [];
...
export function headlessEpisodeSummary(episodeInput = {}) {

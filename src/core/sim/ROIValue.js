export function normalizeROIValue(cell) {
...
export function roiScalar(cell, mode = 'expectedValue') {
...
export function normalizeROIGrid(grid, probabilityMode = 'certain', random = Math.random) {

export const CURRENT_VISUALIZATION_BACKEND_CONTRACT_VERSION = 'current-visualization-backend-contract-flow-r2a';

export const CURRENT_VISUALIZATION_BACKEND_IDS = Object.freeze([
  'webglInstancedGlyphsV1',
  'webglCpuTracerV1',
  'webgpuComputeTracerV1'
]);
...
export function createCurrentVisualizationBackendDescriptor(id = 'webglInstancedGlyphsV1', options = {}) {
  ...
  return {
    ...
    notes: supported
      ? 'Implemented FLOW-R2A WebGL/Three instanced glyph presentation backend.'
      : 'Reserved for a later FLOW phase; not implemented in FLOW-R2A.',
...
export function currentVisualizationBackendRoadmap() {
  return {
    ...
    boundaries: {
      ...
      localPerturbationsMustBeOptionalAndExplicitlySourced: true
    }
  };
}

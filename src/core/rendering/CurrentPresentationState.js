...
export function buildCurrentPresentationDebug({
  ...
  return {
    ...
    currentPackageVersion: currentDebug?.currentPackageVersion ?? null,
    currentManifestDigest: currentDebug?.currentManifestDigest ?? null,
    currentArtifactDigest: currentDebug?.currentArtifactDigest ?? currentDebug?.currentSourceDigest ?? null,
    currentSourceTier: currentDebug?.currentSourceTier ?? null,
    currentCoordinateFrame: currentDebug?.currentCoordinateFrame ?? null,
    currentAxisCounts: currentDebug?.currentAxisCounts ?? null,
    currentValidationStatus: currentDebug?.currentValidationStatus ?? null,
    packageUsesThree: currentDebug?.packageUsesThree === true,
    packageUsesPhaser: currentDebug?.packageUsesPhaser === true,
    packageUsesDom: currentDebug?.packageUsesDom === true,
    packageAcceptsDisplayHours: currentDebug?.packageAcceptsDisplayHours === true,
    packageTimeUnit: currentDebug?.packageTimeUnit ?? 'seconds',

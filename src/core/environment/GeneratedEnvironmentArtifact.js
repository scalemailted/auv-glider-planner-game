...
export const GENERATED_ENVIRONMENT_ARTIFACT_VERSION = 'generated-environment-artifact-env-pkg-r1';
...
export function createGeneratedEnvironmentArtifact(manifestOrOptions = {}, options = {}) {
  ...
  const artifact = {
    ...
    environmentArtifactSummary: environmentArtifactSummary(environmentArtifact),
    componentDigests: environmentComponentDigests(environmentArtifact),
...
export function generatedEnvironmentArtifactSummary(artifact = {}) {
  const environmentSummary = artifact.environmentArtifactSummary ?? (artifact.environmentArtifact ? environmentArtifactSummary(artifact.environmentArtifact) : null);
  return {

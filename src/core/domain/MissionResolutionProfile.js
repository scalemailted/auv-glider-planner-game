...
export function createMissionResolutionProfile(options = {}) {
...
export function createLegacyResolutionProfileFromGrid(grid = {}, options = {}) {
...
export function validateMissionResolutionProfile(profile = {}) {
...
export function missionResolutionProfileSummary(profile = {}) {
  const normalized = normalizeMissionResolutionProfile(profile);
  return {
...
export function resolutionGridForRole(profile = {}, role = 'planning') {
  const normalized = normalizeMissionResolutionProfile(profile);

...
assert.equal(field.sourceLabel, 'Reference bathymetry + synthetic bathymetry-conditioned fields.');
assert.equal(field.fieldGenerationStatus, 'CURRENT');
assert.equal(field.fieldGenerationPolicy.label, 'Reference bathymetry + synthetic bathymetry-conditioned fields.');

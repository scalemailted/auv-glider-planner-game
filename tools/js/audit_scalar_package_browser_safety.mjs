...
const root = path.resolve('packages/scalar-processes/src');
...
await import('../../packages/scalar-processes/src/index.js');
console.log('audit_scalar_package_browser_safety: ok');

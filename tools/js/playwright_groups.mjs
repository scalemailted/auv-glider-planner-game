...
export const PLAYWRIGHT_GROUPS = Object.freeze([
  {
    ...
    patterns: [
      ...
      /^Product Hub Opens Methods and Validation$/i,
      /^Component Claims Metrics and Limitations Are Inspectable$/i,
      /^Official Baseline and Exploratory Rerun Stay Distinct$/i,
      ...
      /^Alpha First-Run Guided Mission$/i,
      ...
      /^Procedural Atlas Field Engine$/i,
      /^Window Generates Bathymetry$/i,
      /^Atlas Region Generates Fields$/i,
      /^Field Regeneration Export Import Cleanup$/i,

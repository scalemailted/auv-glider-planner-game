...
for (const requiredText of [
  ...
  'Loaded Region Inspector',
  'Coarse Preview - Not mission-ready',
  'coarsePreview',
  'stagedSingleTile',
  'stagedMultiTile',
  'Mission-ready generation and launch actions are hidden until staged app-hosted bathymetry tiles exist.',
  'This preview uses app-hosted overview/LOD data. It is not mission-ready.',
